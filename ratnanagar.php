...
<html lang="en">
  ...
  <body>
	...
	<!-- <li><a class="site_list" href="whitelotus.php" >White Lotus</a></li> -->
      ...
      <div id="map1">
		  <iframe id='iframe2' src="https://www.sunnyportal.com/Templates/PublicPage.aspx?page=1bc59ec5-cee0-4fa6-8e9e-3a858f2993db" frameborder="0" style="overflow: hidden; height: 100%;
